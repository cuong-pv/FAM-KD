...
CFG.SOLVER.TYPE = "SGD"
CFG.SOLVER.RHO = 0.05
CFG.SOLVER.RHO_MAX = 10.0
CFG.SOLVER.RHO_MIN = 1.0
CFG.SOLVER.ADAPTIVE = False

# Log
CFG.LOG = CN()
CFG.LOG.TENSORBOARD_FREQ = 500
CFG.LOG.SAVE_CHECKPOINT_FREQ = 40
CFG.LOG.PREFIX = "/mnt/SSD2/tmpCng/FAM_KD_revise/output"
CFG.LOG.WANDB = False
...
# ReviewKD CFG
CFG.FAM_KD = CN()
CFG.FAM_KD.CE_WEIGHT = 1.0
CFG.FAM_KD.FAMKD_WEIGHT = 1.0
CFG.FAM_KD.WARMUP_EPOCHS = 20
CFG.FAM_KD.SHAPES = [1, 8, 16, 32]
CFG.FAM_KD.OUT_SHAPES = [1, 8, 16, 32]
CFG.FAM_KD.IN_CHANNELS = [64, 128, 256, 256]
CFG.FAM_KD.OUT_CHANNELS = [64, 128, 256, 256]
CFG.FAM_KD.MAX_MID_CHANNEL = 512
CFG.FAM_KD.STU_PREACT = False
CFG.FAM_KD.MID_CHANNELS = [1, 2, 3]
CFG.FAM_KD.IN_SHAPES = [1, 2, 3]
CFG.FAM_KD.IN_CHANNELS_X = [1, 2, 3]
CFG.FAM_KD.GUIDE_LAYERS = [1, 2, 3]
